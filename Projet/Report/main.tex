...
% Author information
\customAuthor{Paulo Roberto DE MOURA JÚNIOR, William LIAW}

% Title of the document
\customTitle{Analyzing and Extending Time Series Kernels based on Nonlinear Vector Autoregressive Delayed Embeddings}

% Advisor information
\advisor{Prof. Florence D'Alché}

% Program information
\minipageText{This report is based on the paper \cite{felice2023}, published at NeurIPS 2023.}
